...
// it should look something like: http://hostname/path/to/deployment/directory/I2b2PatientDataExportService/rest
// the hostname must be the external hostname of the machine; 'localhost' or any variation will not work
i2b2.PatientDataExport.SERVICE_URL = 'http://hostname/I2b2PatientDataExportService/rest';
