...
final class I2b2CommUtil {
     ...
     * 
     * @param url the address of the i2b2 instance to POST to
     * @param xml the XML request to send
     * @return the XML response from i2b2 as a {@link String}
     * @throws ClientProtocolException if an error occurs
     * @throws IOException if an error occurs
     */
    static String postXmlToI2b2(String url, String xml)
     ...
     * Copied from the i2b2 SMART project: https://community.i2b2.org/wiki/display/SMArt/SMART+i2b2
